...
HTML_KEY   = "locvix_html_v6"   # bump this when JS/HTML changes break cached output
...
for _old_key in ["locvix_html", "locvix_html_v2", "locvix_html_v3", "locvix_html_v4", "locvix_html_v5"]:
